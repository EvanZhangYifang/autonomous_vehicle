...
class PublishThread(threading.Thread):
    ...
    def change_state(self, switcher):
        self.state = switcher
    ...
    try:
        ...
        while(1):
            ...
            if key in moveBindings.keys():
                ...
                pub_thread.change_state(True)

                resp = srv_client_control_mode(False)
                ...
                pub_thread.change_state(False)

                resp = srv_client_control_mode(True)
